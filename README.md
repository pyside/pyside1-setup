...
1. Install [Python 2.7](http://python.org/download/releases/2.7.3/)

1. Install [Qt 4.8 libraries for Windows (VS 2008)](http://releases.qt-project.org/qt4/source/qt-win-opensource-4.8.2-vs2008.exe)

1. Install [Cmake 2.8](http://www.cmake.org/cmake/resources/software.html)

1. Install [Visual Studio Express 2008](http://www.microsoft.com/express/Downloads/)
...
1. Install [Git 1.7](http://git-scm.com/download/win)
